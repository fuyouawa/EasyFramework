...
namespace EasyFramework.ToolKit
{
    ...
    {
        public static AbstractTweener MoveLocalPos(this Transform transform, Vector3 endPos, float duration)
        {
            return Tween.To(() => transform.localPosition, pos => transform.localPosition = pos, endPos, duration);
        }

        public static AbstractTweener MovePos(this Transform transform, Vector3 endPos, float duration)
        {
            return Tween.To(() => transform.position, pos => transform.position = pos, endPos, duration);
        }

        public static AbstractTweener PlayLocalScale(this Transform transform, Vector3 endLocalScale, float duration)
        {
