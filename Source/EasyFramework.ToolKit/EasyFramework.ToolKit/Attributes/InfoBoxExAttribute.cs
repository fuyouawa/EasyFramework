...
namespace EasyFramework.ToolKit
{
    ...
    public class InfoBoxExAttribute : PropertyAttribute
    {
        /// <summary>
        ...
        public InfoBoxExAttribute(string message, InfoMessageType infoMessageType = InfoMessageType.Info, string visibleIfMemberName = "")
        {
            Message = message;
        ...
        /// <param name="message">The message for the message box. Supports referencing a member string field, property or method by using $.</param>
        /// <param name="visibleIfMemberName">Name of member bool to show or hide the message box.</param>
        public InfoBoxExAttribute(string message, string visibleIfMemberName)
        {
            Message = message;
        ...
        /// <param name="visibleIfMemberName">Name of member bool to show or hide the message box.</param>
        public InfoBoxExAttribute(string message, SdfIconType icon, string visibleIfMemberName = "")
        {
            Message = message;
            Icon = icon;
            VisibleIf = visibleIfMemberName;
