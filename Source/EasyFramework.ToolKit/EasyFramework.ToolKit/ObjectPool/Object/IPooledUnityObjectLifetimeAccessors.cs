...
namespace EasyFramework.ToolKit
{
    ...
    public class PooledUnityObjectLifetimeAccessors : IPooledUnityObjectLifetimeAccessors
    {
        ...
        public PooledUnityObjectLifetimeAccessors(Func<float> activeLifetimeGetter, Action<float> activeLifetimeSetter,
