...
// </copyright>
//-----------------------------------------------------------------------
namespace EasyToolKit.Core.Internal.OdinSerializer
{
    using Utilities;
    using System;
                    ...
                    lock (LOCK)
                    {
                        if (everythingPolicy == null)
                        {
                            everythingPolicy = new CustomSerializationPolicy("OdinSerializerPolicies.Everything", true, (member) =>
                            {
                                ...
                                if (member.IsDefinedBase<OdinSerializeAttribute>(true))
                                {
                                    return true;
                                }
                    ...
                    lock (LOCK)
                    {
                        if (unityPolicy == null)
                        {
                            ...
                            unityPolicy = new CustomSerializationPolicy("OdinSerializerPolicies.Unity", true, (member) =>
                            {
                                ...
                                if (member.IsDefined<NonSerializedAttribute>(true) && !member.IsDefinedBase<OdinSerializeAttribute>())
                                {
                                    return false;
                                }
                                ...
                                return member.IsDefined<SerializeField>(false) || member.IsDefinedBase<OdinSerializeAttribute>(false) || (UnitySerializationUtility.SerializeReferenceAttributeType != null && member.IsDefined(UnitySerializationUtility.SerializeReferenceAttributeType, false));
                            });
                        }
                    }
                }
