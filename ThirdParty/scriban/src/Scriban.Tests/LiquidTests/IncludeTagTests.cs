...
namespace DotLiquid.Tests.Tags
{
    ...
    public class IncludeTagTests
    {
        ...
        class Template
        {
            private EasyToolKit.ThirdParty.Scriban.Template _template;
            public Template(EasyToolKit.ThirdParty.Scriban.Template template)
            {
                _template = template;
            }
            ...
            {
                var scriban = EasyToolKit.ThirdParty.Scriban.Template.ParseLiquid(text);
