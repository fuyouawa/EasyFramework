...
namespace EasyToolKit.Tilemap.Editor
{
    ...
    public static class TilemapSceneViewHandler
    {
        ...
        public static void DrawSceneGUI(TilemapContext context)
        {
            ...
            {
                TilemapHandles.DrawBase(context.Target.transform.position, baseRange, tileSize, context.Target.Asset.Settings.BaseDebugColor);
            }

            TilemapHandles.DrawTileCubes(context.Target.transform.position, context.Target.Asset.TerrainMap, tileSize);
