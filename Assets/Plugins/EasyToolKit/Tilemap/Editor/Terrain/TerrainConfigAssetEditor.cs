    ...
    public class TerrainConfigAssetEditor : EasyEditor
    {
        ...
        private static Texture EmptyIcon
        {
            get
            {
                if (s_emptyIcon == null)
                {
                    s_emptyIcon = TilemapIcons.Instance.GetTerrainRuleGridTypeIcon(TerrainRuleGridType.Empty);
                }
                return s_emptyIcon;
            }
        }
        ...
        private static Texture ContainIcon
        {
            get
            {
                ...
                {
                    s_containIcon = TilemapIcons.Instance.GetTerrainRuleGridTypeIcon(TerrainRuleGridType.Contain);
                }
        ...
        private static Texture OptionIcon
        {
            get
            {
                ...
                {
                    s_optionIcon = TilemapIcons.Instance.GetTerrainRuleGridTypeIcon(TerrainRuleGridType.Option);
                }
                return s_optionIcon;
            }
        }
        ...
        private static Texture UnionIcon
        {
            get
            {
                if (s_unionIcon == null)
                {
                    s_unionIcon = TilemapIcons.Instance.GetTerrainRuleGridTypeIcon(TerrainRuleGridType.Union);
                }
                return s_unionIcon;
            }
        }
        ...
        protected override void DrawProperty(GUIContent label)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                for (int j = 0; j < 3; j++)
                {
                    ...
                    var icon = TilemapIcons.Instance.GetTerrainRuleGridTypeIcon(gridType);
