...
{
    [CustomEditor(typeof(TerrainTileConfigAsset))]
    public class TerrainTileConfigAssetEditor : EasyEditor
    {
    }

    public class TerrainTileConfigAsset_RuleConfigDrawer : EasyValueDrawer<TerrainTileConfigAsset.RuleConfig>
    {
