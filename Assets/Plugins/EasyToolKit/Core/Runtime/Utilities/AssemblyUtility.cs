...
namespace EasyToolKit.Core
{
    ...
    {
        internal const string AssemblyTypeFlagsObsoleteMessage =
            "AssemblyTypeFlags have been made obsolete, because they cannot be determined accurately for all assemblies. Use AssemblyUtilities.GetAssemblyCategory(assembly) instead.";
        ...
        private static readonly Dictionary<Assembly, bool> IsDynamicCache =
            new Dictionary<Assembly, bool>((IEqualityComparer<Assembly>)ReferenceEqualityComparer<Assembly>.Default);
        ...
        private static Assembly unityEditorAssembly = typeof(Editor).Assembly;
        ...
        {
            return TypeConverter.FromName(fullName);
        }
