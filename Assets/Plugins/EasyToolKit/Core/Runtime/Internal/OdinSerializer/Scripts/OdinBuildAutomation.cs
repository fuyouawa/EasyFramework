#if UNITY_EDITOR
namespace EasyToolKit.Core.Internal.OdinSerializer.Utilities.Editor
{
    using EasyToolKit.Core.Internal.OdinSerializer.Editor;
    using UnityEditor;
    ...
    public static class OdinBuildAutomation
    {
        ...
        static OdinBuildAutomation()
        {
            ...
            EditorAssemblyPath    = odinSerializerDir + "/EditorOnly/EasyToolKit.Core.Internal.OdinSerializer.dll";
            AOTAssemblyPath       = odinSerializerDir + "/AOT/EasyToolKit.Core.Internal.OdinSerializer.dll";
            JITAssemblyPath       = odinSerializerDir + "/JIT/EasyToolKit.Core.Internal.OdinSerializer.dll";
