    ...
    static class GameConsoleSystemCommands
    {
        ...
        static void Help(string command)
        {
            ...
            if (command.IsNotNullOrWhiteSpace())
            {
                ...
                if (cmd == null)
                {
                    GameConsoleManager.Instance.LogError($"Unknown command: {command}");
                ...
                GameConsoleManager.Instance.LogInfo(sb.ToString());
            }
            else
            {
        ...
        {
            GameConsoleManager.Instance.LogInfo(message);
        }
        ...
        static void Clear()
        {
            GameConsoleManager.Instance.ClearLogs();
        }
