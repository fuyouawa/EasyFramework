...
//         private readonly Dictionary<Guid, TerrainObject> _terrainObjectsCacheByDefinitionGuid = new Dictionary<Guid, TerrainObject>();
...
//         {
//             if (_terrainObjectsCacheByDefinitionGuid.TryGetValue(terrainDefinitionGuid, out var terrainObject))
//             {
//                 return terrainObject;
//             }

//             terrainObject = MapObject.GetComponentsInChildren<TerrainObject>(true)
//                 .FirstOrDefault(terrainObject =>
//                     terrainObject.TargetTerrainDefinitionGuid == terrainDefinitionGuid);

//             _terrainObjectsCacheByDefinitionGuid[terrainDefinitionGuid] = terrainObject;
//             return terrainObject;
//         }
